package com.haokuo.housemanage.houserentmanage.touchprogressview.widget;
...
public class TouchProgressView extends View {
    ...
    private int pointRadius = 22;//圆点默认半径,单位px
    private int pointColor = R.color.gray_dft;//圆点默认颜色

    private int lineHeight = 3;//线默认高度,单位px
    private int lineClor = R.color.colorLine;//线默认颜色
...
//        pointPaint.setStrokeWidth(3);
        ...
        canvas.drawCircle(25, getHeight() / 2, pointRadius, pointPaint);
    }
